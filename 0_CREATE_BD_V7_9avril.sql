...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`telephone` (
  ...
  `type_telephone` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`etudiant` (
  ...
  `diplome` TINYINT NOT NULL COMMENT 'TRUE si diplomé, FAUX autrement',
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`personnel_polytech` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_personne` INT NOT NULL,
  `mail_universitaire` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`entreprise` (
  ...
  `statut_juridique` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`stage` (
  ...
  `annee_etude_stage` INT NOT NULL,
  `thematique_stage` VARCHAR(255) NOT NULL,
  `sujet_stage` VARCHAR(255) NOT NULL,
  `fonctions_taches_stage` TEXT NOT NULL,
  `details_projet_stage` TEXT NULL,
  `duree_stage_semaines` INT NOT NULL,
  `duree_stage_heures` INT NOT NULL,
  `nb_jours_travail` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`gratification` (
  ...
  `unite_gratification` VARCHAR(45) NOT NULL COMMENT 'BRUT / NET',
  `unite_duree_gratification` VARCHAR(45) NOT NULL COMMENT 'HEURE, MOIS, etc.',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`convention_stage` (
  ...
  `validee_pedagogiquement` TINYINT NOT NULL,
  `id_stage` INT NOT NULL,
  `id_etudiant` INT NOT NULL,
  `id_personne_etudiant` INT NOT NULL,
  `id_specialite` INT NOT NULL,
  `id_etablissement` INT NOT NULL,
  `id_personnel_polytech_tuteur` INT NOT NULL,
  `id_personne_personnel_polytech_tuteur` INT NOT NULL,
  `id_personnel_polytech_charge_suivi` INT NOT NULL,
  `id_personne_personnel_polytech_charge_suivi` INT NOT NULL,
  `id_contact_etablissement_tuteur` INT NOT NULL,
  `id_personne_contact_etablissement_tuteur` INT NOT NULL,
  `id_contact_etablissement_signataire` INT NOT NULL,
  `id_personne_contact_etablissement_signataire` INT NOT NULL,
  `id_gratification` INT NULL,
  `id_service_accueil` INT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`apprentissage` (
  ...
  `duree_apprentissage_annees` INT NOT NULL COMMENT '1 an, 3 ans, etc.',
  `etranger` TINYINT NOT NULL,
  `details_apprentissage` TEXT NULL,
  `id_gratification` INT NOT NULL,
  `id_specialite` INT NOT NULL,
  `id_personne_etudiant` INT NOT NULL,
  `id_etudiant` INT NOT NULL,
  `id_etablissement` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db_rel_ent_pol_tours`.`verse_taxe_apprentissage` (
  ...
  PRIMARY KEY (`id_departement`, `id_etablissement`, `annee_versement`),
  INDEX `fk_VerseTaxeApprentissage_Etablissement1_idx` (`id_etablissement` ASC),
  CONSTRAINT `fk_VerseTaxeApprentissage_Departement1`
    FOREIGN KEY (`id_departement`)
    REFERENCES `db_rel_ent_pol_tours`.`departement` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_VerseTaxeApprentissage_Etablissement1`
    FOREIGN KEY (`id_etablissement`)
    REFERENCES `db_rel_ent_pol_tours`.`etablissement` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
